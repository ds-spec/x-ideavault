import { ChevronRight, CirclePlus, Eye, Flame, Sparkles } from "lucide-react";
...
const IdeaFlow = (): JSX.Element => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-3 md:grid-rows-2 w-full min-h-screen px-5 gap-4">
      ...
      <div className="rounded-xl  items-center justify-center text-white hidden md:flex">
        <ChevronRight size={35} color="#007AFF" />
      </div>
      <div className="w-full h-full flex flex-col gap-5 items-center justify-center  text-white">
        <div className="flex items-center justify-center bg-[#0A1B3A] rounded-full p-4">
          <CirclePlus color="#007AFF" size={35} />
        </div>
      ...
      <div className="items-center justify-center text-white hidden md:flex">
        <ChevronRight size={35} color="#007AFF" className="" />
      </div>
      <div className="w-full h-full flex flex-col gap-5 items-center justify-center text-white">
        <div className="flex items-center justify-center bg-[#0A1B3A] rounded-full p-4">
          <Flame color="#007AFF" size={35} />
        </div>
